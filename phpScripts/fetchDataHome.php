...
$select_photos_query = "SELECT foto_id, usu_nombre, foto_fecha, foto_coment, foto_ruta FROM fotos";
...
if ($result_select) {
    ...
    echo json_encode($u_posts, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); //[array{object}]
} else {
